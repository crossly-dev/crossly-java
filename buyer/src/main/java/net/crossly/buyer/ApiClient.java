...
import net.crossly.buyer.auth.Authentication;
import net.crossly.buyer.auth.HttpBasicAuth;
import net.crossly.buyer.auth.HttpBearerAuth;
import net.crossly.buyer.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://crossly.net/api";
    ...
    public ApiClient() {
        ...
        authentications.put("BuyerOAuth", new HttpBearerAuth("bearer"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://crossly.net/api
