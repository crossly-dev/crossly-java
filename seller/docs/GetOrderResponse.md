...
**handlingTimeDays** | **BigDecimal** |  |  [optional]
...
**labelPurchasedAt** | **OffsetDateTime** |  |  [optional]
**shippedAt** | **OffsetDateTime** |  |  [optional]
...
**trackingSubmittedAt** | **OffsetDateTime** |  |  [optional]
...
**shipByAt** | **OffsetDateTime** |  |  [optional]
**shipByAlertedAt** | **OffsetDateTime** |  |  [optional]
**oversoldBy** | **BigDecimal** |  | 
**lastStatusCheckAt** | **OffsetDateTime** |  |  [optional]
**lastChatCheckAt** | **OffsetDateTime** |  |  [optional]
**isDisputed** | **Boolean** |  | 
**disputeReason** | **String** |  |  [optional]
**disputePlatformCaseId** | **String** |  |  [optional]
**disputeResolvedAt** | **OffsetDateTime** |  |  [optional]
...
**arrivalConditionRequestedAt** | **OffsetDateTime** |  |  [optional]
**arrivalConditionSubmittedAt** | **OffsetDateTime** |  |  [optional]
**arrivalConditionDeclinedAt** | **OffsetDateTime** |  |  [optional]
